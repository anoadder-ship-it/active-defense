 ...
 * Upgrade Authority: same keypair as Program ID for now (single dedicated
 * dev identity, ~/.config/active-defense/program-keypairs/ — this repo has
 * no multisig yet, unlike spankwallet). Update this comment the day that
 * changes.
 *
 ...
 * spankwallet WalletAccount (read-only). spankwallet's real, multisig-governed
 * program ID and account layout are an external, version-pinned dependency —
 * see STATUS.md for which spankwallet commit this was last verified against.
 */
